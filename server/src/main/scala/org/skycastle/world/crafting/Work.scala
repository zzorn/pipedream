...
case class Work(skill:      Symbol, // Skill type used.  E.g. blacksmithing, carpentry, surgery.
                workType:   Action, // E.g. cutting, sawing, screwing, hammering, carving, shaping.  Determines tools that can be used.
